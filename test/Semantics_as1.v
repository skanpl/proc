...
Instance HSubstLemmas_proc : HSubstLemmas chan proc. derive. Qed.
Instance SubstHSubstComp_chan_proc : SubstHSubstComp chan proc. derive. Qed.
...
(*_______   des tests ___*)
Print ren.
 
Definition foo := Send (Nchan 1) (Nchan 2) Zero.

Print ren.
Definition bar := rename (+9) (Nchan (1))  .
...
Definition shift_pr (P:proc) := P .[fun x => Nchan (x+1)].  
Definition shiftn_pr n (P:proc) := P .[fun x => Nchan (x+n)].  
